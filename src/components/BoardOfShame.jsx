...
export default function BoardOfShame({ entries, players, canWrite, onCreate, onDelete }) {
  ...
  return <section className="board-shame-section">
    <div className="board-shame-head"><div><p className="eyebrow">THE HALL OF FAME'S OPPOSITE</p><h2>Board of shame</h2></div>{canWrite && <button className="primary-btn" type="button" onClick={() => { setError(""); setIsOpen(true); }}>Add entry <span>+</span></button>}</div>
