  ...
  return (
    <article className={"match-card " + (isExpanded ? "expanded" : "collapsed")}>
      {isExpanded && <div className={"match-card-top " + (canWrite ? "can-write" : "guest")}>
        ...
        <span className="match-logged-by">Logged by {match.loggedBy || "Guest"}</span>
